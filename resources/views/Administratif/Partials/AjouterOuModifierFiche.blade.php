    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('Administratif.CreerOuModifierFiche', $candidat->id) }}" method="POST" class="text-start"
                    ...
                    <div class="questionnaire-form" id="questionnaire-form-{{ $candidat->id }}" style="display: none;">
                        ...
                        <div class="input-group input-group-outline mb-3 p-2">
                            <label for="date_naissance_conjoint" class="form-label">2- Quelle est votre date de
                                naissance ?</label>
