    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('DossierContacts') }}" method="POST" class="text-start" id="contactForm">
                    @csrf
                        ...
                        <button type="button" class="btn bg-gradient-primary w-40 my-4 mb-2" id="submitFormButton">AJOUTER</button>
