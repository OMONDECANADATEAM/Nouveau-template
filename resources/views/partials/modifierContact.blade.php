                ...
                <form action="{{ route('modifierContact', $candidat->id) }}" method="POST" class="text-start" id="modifierContactForm{{ $candidat->id }}">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input consultation-payee" type="checkbox" name="consultation_payee" id="consultation-payee-{{ $candidat->id }}" {{ $candidat->consultation_payee ? 'checked' : '' }}>
                    ...
                    <div class="questionnaire-form" id="questionnaire-form-{{ $candidat->id }}" style="display: none;">
                            ...
                            <div class="input-group input-group-outline mb-3 p-2">
                                ...
                                <input type="text" name="statut_matrimonial" id="statut_matrimonial" class="form-control"  value="{{ $candidat->ficheConsultation ? $candidat->ficheConsultation->reponse1 : '' }}" required>
                            </div>
