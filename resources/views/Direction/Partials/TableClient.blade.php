<div class="card my-4">
    <div class="card-header p-0 position-relative mt-n4 mx-3">
        <div
            class="bg-gradient-dark border-radius-lg pt-4 pb-2 d-flex align-items-center justify-content-between p-4 flex-wrap">
            <div class="p-2 border-radius-lg w-100 w-md-40 bg-white">
                <input type="text" id="searchInput" class="form-control text-dark text-lg bg-transparent border-0 p-1"
                    placeholder="Rechercher...">
            </div>
            <div class="p-2 d-flex align-items-center w-100 w-md-30 justify-content-around flex-wrap">
                <div class="dropdown">
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <span class="text-md consultante-name">
                                    @if ($candidat->proceduresDemandees)
                                        {{ $candidat->proceduresDemandees->consultante->nom ?? 'N / A' }}
                                        {{ $candidat->proceduresDemandees->consultante->prenoms ?? '' }}
                                    @else
                                        N / A
                                    @endif
                                </span>
