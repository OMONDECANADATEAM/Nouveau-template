            ...
            if ($candidat->consultation_payee) {
                ...
                FicheConsultation::updateOrCreate(
                    ...
                    [
                        ...
                        'reponse15' => $request->input('diplome_etudes') == 'non' ? 'pas de diplome' : $request->input('annee_obtention_diplome'),
                        ...
                        'reponse20' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('niveau_scolarite_conjoint'),
                        'reponse21' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('domaine_formation_conjoint'),
                        'reponse22' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('age_conjoint'),
                        'reponse23' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('niveau_francais'),
                        'reponse24' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('niveau_anglais'),
                        'reponse25' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('age_enfants_linguistique'),
                        'reponse26' => $request->input('statut_matrimonial') == 'Celibataire' ? 'Sans objet' : $request->input('niveau_scolarite_enfants'),
