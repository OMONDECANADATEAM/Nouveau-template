document.addEventListener("DOMContentLoaded", function() {
    $.get('/Commercial/AppelsChart', function(data) {
    ...
    $.get('/Commercial/ConsultationsChart', function(data) {
        // Triez les mois dans l'ordre croissant (de janvier à décembre)
        const monthOrder = [
        ...
        new Chart(ctx2, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    fill: true,
                    data: sortedData.map(entry => entry.count),
                    maxBarThickness: 6
                }],
            },
            options: {
